...
{
	private static final String		TAG						= GLSurfaceViewEGL14.class.toString();
	...
	private static class EglHelper
	{
		...
		private static void cacheError(final String errorMessage)
		{
			try
			{
				...
				{
					EglHelper.cachedErrors = new HashMap<String, Integer>();
				}
	...
	static class GLThread extends Thread
	{
		...
		public final ArrayList<Runnable>				mEventQueue		= new ArrayList<Runnable>();
	...
	private final WeakReference<GLSurfaceViewEGL14>	mThisWeakRef		= new WeakReference<GLSurfaceViewEGL14>(this);
